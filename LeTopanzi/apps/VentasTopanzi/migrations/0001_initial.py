# Generated by Django 2.2.6 on 2019-11-30 19:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rut', models.IntegerField(verbose_name='Rut sin DV: 18224351')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('codigoContacto', models.CharField(max_length=30, verbose_name='Código Contacto')),
                ('nombre', models.CharField(max_length=30, verbose_name='Nombre')),
                ('apellido', models.CharField(max_length=30, verbose_name='Apellido')),
                ('correo', models.EmailField(max_length=254, verbose_name='Correo')),
                ('telefono', models.CharField(max_length=20, verbose_name='Teléfono')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('codigoProducto', models.CharField(max_length=30, verbose_name='Código Producto')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('codigoVenta', models.CharField(max_length=30, verbose_name='Código Producto')),
